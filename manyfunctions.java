...
public class manyfunctions
{
     ...
     */
    public static int maximum(int d, int e)
    {
     ...
     */
    public static boolean isOddNumber(int k )
    {
        if(k%2==1 )
        {
            return true ;
    ...
    {
        if(z=='a'|| z=='A' ||z=='e'|| z=='E'||z=='i'||z=='o'|| z=='u')
        {
            return true;
        }
        else
     ...
     */
    public static boolean isConsonant(char y)
    {
        if(y!='i' && y!='I' && y!='a' &&y!='e'&& y!='o'&& y!='u' )
        {
            return true;
        }
        else
    ...
    public static void main(String[] args)
    {
        ...
        if (isConsonant('I')) {
            out.println("Error 26: isConsonant failed test.  Expect isConsonant('I') to be false, but got true.");
            testFailures++;
        }
